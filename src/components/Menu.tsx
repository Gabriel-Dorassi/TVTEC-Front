...
export default function Menu() {
  ...
  // Verificar se o usuário está autenticado quando o componente é montado
  useEffect(() => {
    const checkAuth = () => {
    ...
    // Adicionar um ouvinte para armazenamento local para detectar mudanças de login/logout
  ...
  // Classe para links inativos (hover)
    ...
    <nav className="bg-gray-800 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo e links de navegação para desktop */}
      ...
      <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        ...
        {/* Seção de autenticação para mobile */}
